...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:scale-105 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-primary to-purple-600 text-primary-foreground hover:from-primary/90 hover:to-purple-600/90 shadow-lg hover:shadow-xl",
        destructive:
        ...
        outline:
          "border-2 border-primary/20 bg-background hover:bg-primary/5 hover:text-accent-foreground hover:border-primary/40",
        secondary:
          "bg-gradient-to-r from-secondary to-slate-200 text-secondary-foreground hover:from-secondary/80 hover:to-slate-200/80",
